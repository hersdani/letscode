...
class Cliente:
    ...
    def alugar_bicicleta(self, numero_bicicletas_alugadas, modo_aluguel, duracao, loja):
        ...
        loja.recebe_aluguel(numero_bicicletas_alugadas, modo_aluguel, duracao)
...
class Loja:
    ...
    def recebe_aluguel(self, numero_bicicletas_alugadas, modo_aluguel, duracao):
        ...
        #(duração > 0 - colocar um limite? hora < 24h, dia < 7, semana xxx?)
        elif (modo_aluguel == 'hora' and duracao >= 24) or (modo_aluguel == 'dia' and duracao >= 7) or (duracao <= 0) or (modo_aluguel == 'semana' and duracao >= 52):
            ...
            print("Bikes alugadas pelo cliente:", self.numero_bicicletas_alugadas)
...
loja1.calcular_valor(cliente2)

cliente1.alugar_bicicleta(50, 'dia', 3, loja1)
cliente2.alugar_bicicleta(5, 'semana', 3, loja1)