...
class Loja:
    ...
    def calcular_valor(self, cliente):
        ...
        if len(self.alugueis_ativos) == 0:
            ...
            # fazer uma verificacao por cpf pra saber se esta com aluguel ou nao. desta forma q fiz nao funciona bem
        # elif self.cliente.numero_bicicletas_alugadas == 0:
        #     print('Não há alugueis ativos! Não é possível calcular o valor.')
        elif (cliente.numero_bicicletas_alugadas) >= 1:
...
# está dando erro ao calcular sem ter aluguel antes
